        ...
        return (
            <div className="preview">
                <section className="primary-column">
                    ...
                    </svg>{work.position}</h3>
                    <h4>{work.companyName}<span>{work.startDateWo} - {work.endDateWo}</span></h4>
                    <p>{work.summaryWo}</p>
                    <h2>Education</h2>
                    <h3><svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32">
                    ...
                    </svg>{education.studyTitle}</h3>
                    <h4>{education.schoolName}<span>{education.startDateEd} - {education.endDateEd}</span></h4>
                    <p>{education.summaryEd}</p>
                </section>
                <section className="secondary-column">
                    ...
                    <h2>Skills</h2>
                    <ul className="skills">
                        <li><span>{skill.skillName}</span>: {skill.summarySk}</li>
                    </ul>
                </section>
